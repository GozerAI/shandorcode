...
"""
Quick test script to validate CodeGraph functionality.
"""
...
def main():
    print("=" * 60)
    print("CodeGraph Test - Analyzing itself!")
    print("=" * 60)
    
    # Analyze the codegraph project itself
    analyzer = CodeAnalyzer("/home/claude/codegraph/src")
    ...
    print(f"\n🎉 Test complete! CodeGraph is working correctly.")
