...
└─────────────────────┬───────────────────────────────────┘
                      │
┌─────────────────────▼───────────────────────────────────┐
│           Code Analyzer (src/visualization/core/analyzer.py)          │
│  ┌──────────────────────────────────────────────────┐  │
│  │  • File discovery                                │  │
...
│   (src/visualization/parsers/)     │  │   (src/visualization/core/watcher.py)      │
│  ┌────────────────┐  │  │  ┌────────────────────────┐  │
...
### 1. Data Models (src/visualization/core/models.py)
...
### 2. Language Parsers (src/visualization/parsers/)
...
### 3. Code Analyzer (src/visualization/core/analyzer.py)
...
### 4. File Watcher (src/visualization/core/watcher.py)
...
1. Create parser class in `src/visualization/parsers/`
...
- **Zuultimate**: Validates entitlements at the HTTP layer
